...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE tbl_portfolio SET Name='$name', Description='$desc' WHERE ID='$id'";
    if (mysqli_query($connection, $sql)) {
        echo "<script>alert('Items updated successfully!')</script>";
        ...
        <div class="col-md-6 offset-md-3"> 
            <div class="form-box">
                ...
                <form style="text-align: center; padding: 15px 20px; font-family: sans-serif;" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    Name<br><input style="margin: 20px; border-radius: 5px; border: solid 1px; width:30%; height:30px;" type="text" name="Name" value="<?php echo $name; ?>"> <br>
                    Description<br> <input style="margin: 20px; border-radius: 5px; border: solid 1px; width:60%; height:40px;" type="message" name="Description" value="<?php echo $desc; ?>"> <br>
