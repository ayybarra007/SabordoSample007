...
<head>
    ...
    <link href='https://unpkg.com/boxicons@2.1.1/css/boxicons.min.css' rel='stylesheet'>
     ...
     <title>Mac-Creates | Portfolio</title>
</head>
<body>
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<h1 style='font-size:300%;' position: absolute; top:-10%;>" . $row["Name"] . "</h1>"; 
      
      echo "<h2 style='font-size:200%;' position: absolute; >" . $row["Description"] . "</h2>"; 
  }
} 
...
?>
        ...
        <p style="font-size: 100%;">Mac has mastered the art of creating <br>
            ...
            through.</p>
       <button style="background-color: black; border-radius: 23%; backdrop-filter: blur(8px);">Let's Collab..</button>
<style> 
